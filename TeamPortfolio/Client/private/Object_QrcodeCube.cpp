#include "stdafx.h"
#include "..\public\Object_QrcodeCube.h"


CObject_QrcodeCube::CObject_QrcodeCube(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CObject_QrcodeCube::CObject_QrcodeCube(const CObject_QrcodeCube & rhs)
	: CGameObject(rhs)
{
}

HRESULT CObject_QrcodeCube::Initialize_Prototype(void * pArg)
{
...
HRESULT CObject_QrcodeCube::Initialize_Clone(void * pArg)
{
	...
	m_ComTransform->Set_MatrixState(CTransform::STATE_POS, _float3(8.5f, 22.f, 9.5f));
...
_int CObject_QrcodeCube::Update(_float fTimeDelta)
{
...
_int CObject_QrcodeCube::LateUpdate(_float fTimeDelta)
{
...
_int CObject_QrcodeCube::Render()
{
...
_int CObject_QrcodeCube::LateRender()
{
...
_int CObject_QrcodeCube::Obsever_On_Trigger(CGameObject* pDestObjects, _float3 fCollision_Distance, _float fDeltaTime)
{
...
HRESULT CObject_QrcodeCube::SetUp_Components()
{
	/* For.트랜스폼 */
...
HRESULT CObject_QrcodeCube::SetUp_RenderState()
{
...
HRESULT CObject_QrcodeCube::Release_RenderState()
{
...
CObject_QrcodeCube * CObject_QrcodeCube::Create(LPDIRECT3DDEVICE9 pGraphic_Device, void * pArg)
{
	CObject_QrcodeCube* pInstance = new CObject_QrcodeCube(pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype(pArg)))
	{
		MSGBOX("Fail to Create CObject_QrcodeCube");
...
CGameObject * CObject_QrcodeCube::Clone(void * pArg)
{
	CObject_QrcodeCube* pInstance = new CObject_QrcodeCube((*this));
