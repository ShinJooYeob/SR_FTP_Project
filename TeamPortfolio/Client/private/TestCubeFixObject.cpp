#include "stdafx.h"
#include "..\public\TestCubeFixObject.h"


CTestCubeFixObject::CTestCubeFixObject(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CTestCubeFixObject::CTestCubeFixObject(const CTestCubeFixObject & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTestCubeFixObject::Initialize_Prototype(void * pArg)
{
...
HRESULT CTestCubeFixObject::Initialize_Clone(void * pArg)
{
	...
	m_ComTransform->Scaled(_float3(10.f, 10.f, 10.f));

	m_ComTransform->Set_MatrixState(CTransform::STATE_POS, _float3(10.f, 10.f, 10.f));

	return S_OK;
}

_int CTestCubeFixObject::Update(_float fTimeDelta)
{
...
_int CTestCubeFixObject::LateUpdate(_float fTimeDelta)
{
...
_int CTestCubeFixObject::Render()
{
...
_int CTestCubeFixObject::LateRender()
{
...
_int CTestCubeFixObject::Obsever_On_Trigger(CGameObject* pDestObjects, _float3 fCollision_Distance, _float fDeltaTime)
{
...
HRESULT CTestCubeFixObject::SetUp_Components()
{
	/* For.트랜스폼 */
	...
	/* For. 텍스쳐*/
	if (FAILED(__super::Add_Component(SCENE_STAGESELECT, TEXT("Prototype_Component_FixObject_Texture"), TEXT("Com_Texture"), (CComponent**)&m_ComTexture)))
		return E_FAIL;
...
HRESULT CTestCubeFixObject::SetUp_OnTerrain(_float fDeltaTime)
{
...
HRESULT CTestCubeFixObject::SetUp_RenderState()
{
...
HRESULT CTestCubeFixObject::Release_RenderState()
{
...
CTestCubeFixObject * CTestCubeFixObject::Create(LPDIRECT3DDEVICE9 pGraphic_Device, void * pArg)
{
	CTestCubeFixObject* pInstance = new CTestCubeFixObject(pGraphic_Device);
...
CGameObject * CTestCubeFixObject::Clone(void * pArg)
{
	CTestCubeFixObject* pInstance = new CTestCubeFixObject((*this));
