...
class CNpc_geezer : public CNpc
{
private:
	explicit CNpc_geezer(LPDIRECT3DDEVICE9	pGraphicDevice);
	explicit CNpc_geezer(const CNpc_geezer& rhs);
	virtual	~CNpc_geezer() = default;
...
public:
	static CNpc_geezer* Create(LPDIRECT3DDEVICE9 pGraphicDevice, void* pArg = nullptr);
