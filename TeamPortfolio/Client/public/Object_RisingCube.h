...
class CObject_RisingCube final : public CGameObject
{
private:
	explicit CObject_RisingCube(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CObject_RisingCube(const CObject_RisingCube& rhs);
	virtual ~CObject_RisingCube() = default;
public:
...
public:
	static CObject_RisingCube* Create(LPDIRECT3DDEVICE9 pGraphic_Device, void* pArg = nullptr);
