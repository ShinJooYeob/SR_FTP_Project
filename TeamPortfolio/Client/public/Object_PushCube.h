...
class CObject_PushCube final : public CGameObject
{
private:
	explicit CObject_PushCube(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CObject_PushCube(const CObject_PushCube& rhs);
	virtual ~CObject_PushCube() = default;
public:
	...
	virtual _int Collision_Moving(CGameObject* pDestObjects, _float3 fCollision_Distance, _float fDeltaTime);
...
public:
	static CObject_PushCube* Create(LPDIRECT3DDEVICE9 pGraphic_Device, void* pArg = nullptr);
