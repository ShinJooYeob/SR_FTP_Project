...
class CParsedObject_BigOwlHead final : public CParsedObject
{
private:
	explicit CParsedObject_BigOwlHead(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CParsedObject_BigOwlHead(const CParsedObject_BigOwlHead& rhs);
	virtual ~CParsedObject_BigOwlHead() = default;
